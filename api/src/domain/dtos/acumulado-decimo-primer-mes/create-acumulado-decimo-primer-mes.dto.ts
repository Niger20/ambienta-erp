export class CreateAcumuladoDecimoPrimerMesDto {
    ...
    static create(props: { [key: string]: any }): [string?, CreateAcumuladoDecimoPrimerMesDto?] {
        const { empleadoid, periodoid, salariobruto, montoacumulado, montopagado, fechageneracion } = props;
        ...
        return [
            undefined,
            new CreateAcumuladoDecimoPrimerMesDto(
                parsedEmpleadoId,
                parsedPeriodoId,
                parsedSalario,
                parsedAcumulado,
