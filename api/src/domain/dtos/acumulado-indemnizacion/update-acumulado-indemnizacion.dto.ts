export class UpdateAcumuladoIndemnizacionDto {
    ...
    static create(props: { [key: string]: any }): [string?, UpdateAcumuladoIndemnizacionDto?] {
        const { id, empleadoid, periodoid, salariobruto, montoacumulado, fechageneracion } = props;
        ...
        return [
            undefined,
            new UpdateAcumuladoIndemnizacionDto(
                parsedId,
                parsedEmpleadoId,
                parsedPeriodoId,
